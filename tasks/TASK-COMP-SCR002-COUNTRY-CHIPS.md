# COMP-SCR002-COUNTRY-CHIPS - 방문 국가 30개 Chip

Category: Component | Implementation Status: IMPLEMENT | Priority: P2

## Context

방문 국가 30개를 권역별로 그룹핑한 Chip 목록.

## Project Scope

이 Task가 다루는 모든 Requirement(REQ-FUNC-059)는 `docs/PROJECT_SCOPE.md` 기준 **IMPLEMENT**로 분류되어 있으며 `docs/06_SRS_UIUX_REVISED.md`/`docs/UIUX_TRACEABILITY.md`에서 이 Task ID로 추적된다. EXCLUDED Requirement는 이 Task에 배정되지 않는다.
...
- `src/components/about/CountryChips.tsx`
